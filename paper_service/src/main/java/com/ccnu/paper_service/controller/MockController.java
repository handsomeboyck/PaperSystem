...
public class MockController {
     ...
     * 返回身份证号
     */
    private static String[] telFirst="42,41,43,44,45,46,47,48,49,31,32,33,34,35,46,37,38,39,40".split(",");
    private static String getCardNum() {
        int index=getNum(0,telFirst.length-1);
        String first=telFirst[index];
        String second=String.valueOf(getNum(1,888)+10000).substring(1);
        String third=String.valueOf(getNum(1,9100)+10000).substring(1);
        String four=String.valueOf(getNum(1,8521)+10000).substring(1);
        String five=String.valueOf(getNum(1,7777)+10000).substring(1);
    ...
    private static String getRoad() {
        ...
        String second=String.valueOf(getNum(150,1500))+"号";
    ...
    public JsonData MockInsert()
    {
        for(int i =0;i<500;i++)
        {
            DefendantOne defendantOne = new DefendantOne();
            defendantOne.setLawyerId(1);
            defendantOne.setNature("汉族");
            defendantOne.setCardNum(getCardNum());
            defendantOne.setSex(name_sex);
            defendantOne.setAddress(getRoad());
            defendantOne.setName(getChineseName());
